...
class LessonCreate(LessonBase):
    """Payload for creating lessons within a module path parameter."""
...
class ModuleCreate(ModuleBase):
    """Payload for creating modules scoped by the course path parameter."""
...
class AssignmentCreate(AssignmentBase):
    """Payload for creating assignments under a course path parameter."""
